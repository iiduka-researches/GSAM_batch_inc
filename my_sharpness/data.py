...
def get_loaders(dataset, n_ex, batch_size, split, shuffle, data_augm, val_indices=None, p_label_noise=0.0,
    ...
    if normalization and 'cifar100' in dataset:
        transform_list.append(transforms.Normalize((0.5070751592371323, 0.48654887331495095, 0.4409178433670343), (0.2673342858792401, 0.2564384629170883, 0.27615047132568404)))
    elif normalization and 'cifar10' in dataset:
